...
class SetupProfileWelcomeScreen extends StatelessWidget {
  const SetupProfileWelcomeScreen({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Expanded(
          child: SizedBox(
            ...
            child: Image.asset(AppImages.imgSetupProfileWelcome,
              fit: BoxFit.cover,
            ),
          ),
        ),
        ...
        Padding(
          ...
          child: Text('setup_your_profile'.tr,
        ...
        Padding(
          ...
          child: Text('message_setup_profile_welcome'.tr,
            textAlign: TextAlign.center,
            maxLines: 3,
            overflow: TextOverflow.ellipsis,
        ...
        Padding(
          ...
          child: CommonButton(text: 'start_setup'.tr, clickAction: (){
            Get.toNamed(AppRoutes.routeAboutBusinessScreen);
          }),
        ),
