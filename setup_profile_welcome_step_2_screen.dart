...
class SetupProfileWelcomeStep2Screen extends StatelessWidget {
  const SetupProfileWelcomeStep2Screen({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Expanded(
            child: SizedBox(
              ...
              child: Image.asset(AppImages.imgSetupProfileWelcomeStep2,
                fit: BoxFit.cover,
              ),
            ),
          ),
          ...
          Padding(
            ...
            child: Text('profile_setup_welcome_step_2_title'.tr,
          ...
          Padding(
            ...
            child: Text('profile_setup_welcome_step_2_subtitle'.tr,
              textAlign: TextAlign.center,
              maxLines: 3,
              overflow: TextOverflow.ellipsis,
          ...
          Padding(
            ...
            child: CommonButton(text: 'continue'.tr, clickAction: (){
              Get.toNamed(AppRoutes.routeSelectWorkPreferenceScreen);
            }),
          ),
